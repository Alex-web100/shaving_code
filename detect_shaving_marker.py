...
class MoveToTagNode(hm.HelloNode):
    ...
    def move_to_shaving_position(self):
        ...
        pose = {'wrist_extension': .3, 'joint_wrist_pitch':-.3708, 'joint_wrist_yaw':.157, 'joint_lift':.8056, 'joint_gripper_finger_left':.1}
        self.move_to_pose(pose)
        rospy.sleep(3)
    ...
    def main(self):
        ...
        self.trigger_write_hello_service = rospy.Service('/hello_world/trigger_report_lift_effort',
                                                         Trigger,
                                                         self.trigger_report_lift_effort)

        self.trigger_write_hello_service = rospy.Service('/hello_world/trigger_shaving_position',
                                                         Trigger,
